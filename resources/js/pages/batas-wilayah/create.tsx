...
export default function CreateBatasWilayah() {
    ...
    return (
        <AppLayout>
            <Head title="Tambah Batas Wilayah" />
            <div className="p-6 space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Tambah Batas Wilayah</h1>
                        <p className="text-muted-foreground">Gambar polygon batas wilayah dan atur warna serta opacity</p>
                    </div>
                </div>
                    ...
                    <Card className="h-fit">
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <Button type="submit" className="w-full" disabled={processing || data.coordinates.length === 0}>
                                <Save className="mr-2 h-4 w-4" /> Simpan Batas Wilayah
                            </Button>
                        </CardContent>
                    </Card>
                            ...
                            >
                                ...
                                <MapLegend
                                    ...
                                    items={Object.entries(LAND_USE_COLORS).map(([label, color]) => ({
                                        label,
                                        color,
                                        type: 'point' // Show as standard color dots
                                    }))}
                                />
                            </MapContainer>
                        </div>
